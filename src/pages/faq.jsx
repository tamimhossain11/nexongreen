...
const FAQS = {
  general: [
    ...
    { q: "Where is NexonGreen based?", a: "NexonGreen is headquartered at 98 Road No. 9A, Dhanmondi, Dhaka-1205, Bangladesh. While we are based in Bangladesh, we work with clients across the globe and deliver projects remotely with no quality compromise." },
